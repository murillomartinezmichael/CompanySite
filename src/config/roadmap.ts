...
export const DROPS: Drop[] = [
  ...
  },
  {
    ...
    blurb: 'Multi-seven construction client — residential build plus home repair, split into buyer lanes so a homeowner and a general contractor never have to read the same page.',
    quarter: 'Already shipped — live right now',
    dateLabel: 'LIVE',
    year: '2026',
    date: '2026-07-17',
  ...
  {
    name: 'ResumeSite',
    blurb: 'Recruiter-facing single-URL landing page — the top of a resume, replacing twelve open tabs. WCAG 2.1 AA baseline, byte-reproducible resume PDF, Lighthouse 100/100/100/100 on every page and form factor.',
    quarter: 'Already shipped — live right now',
    dateLabel: 'LIVE',
    year: '2026',
    date: '2026-07-19',
