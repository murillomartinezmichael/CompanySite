...
export const DROPS: Drop[] = [
  // September 2026 — the M³ launch
  {
    ...
    quarter: 'September 2026 — the M³ launch',
    dateLabel: 'SEP 1',
    year: '2026',
    date: '2026-09-01',
    url: 'https://m3mm.net',
  ...
  },
  {
    ...
    blurb: 'First M³ client shipped and paid — David Serrano\'s outdoor-living crew. Live portfolio, contact intake, mobile-first, Lighthouse 95+. Ships as the proof: this is what an M³ site looks like in the wild.',
    quarter: 'September 2026 — the M³ launch',
    dateLabel: 'SEP 15',
    year: '2026',
    date: '2026-09-15',
  ...
  {
    name: 'Big7Construction',
    blurb: 'Multi-seven construction client site — residential build plus home repair. Ships as an M³ portfolio case study and a live client reference.',
    quarter: 'Q4 2026',
    dateLabel: 'OCT 27',
    year: '2026',
    date: '2026-10-27',
  ...
  {
    name: 'ResumeSite',
    blurb: 'Recruiter-facing single-URL landing page — top of resume, replacing 12 tabs. WCAG AA baseline, byte-reproducible resume PDF, Lighthouse 100/100/100/100.',
    quarter: 'Q4 2026',
    dateLabel: 'NOV 10',
    year: '2026',
    date: '2026-11-10',
