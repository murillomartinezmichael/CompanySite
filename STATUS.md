...
| 4. SPEED | Real Lighthouse in Chrome, fix the top bottleneck only | ✅ 2026-07-07 (strike #1 font-defer -247ms blocking, commit `7040dcf` · strike #2 case-study video lazy-load -6.69 MB / -98.2 % of page weight + -271 ms FCP/SI/TTI, commits `8481eb2` + `4eaabd5`. Baseline + deltas in `docs/lighthouse-baseline.md`.) |
