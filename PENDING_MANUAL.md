...
- [ ] **Stripe Payment Link for the directly-buyable $500 Basic tier.**
  ...
  - **What to do (Mike only, ~5 min):**
    1. Stripe dashboard → **live mode** (not test) → Payment links → create a link for **$100 USD**, name it `M³ Basic site — 20% down payment`, description noting the down payment is non-refundable and the $400 balance is due before launch.
