...
**NEXT ACTION (2026-07-16):** Mike: give the live homepage FAQ one physical-keyboard smoke (Tab to a question, then toggle with Enter/Space). Responsive layout, pointer toggling, focus visibility, overflow, and production presence are verified; the FAQ is committed on `origin/main` in `efa2278` and serves at `https://m3mm.net`.
