...
**NEXT ACTION (2026-07-20):** After the policy commit reaches production, verify m3mm.net renders the 20% non-refundable down-payment copy on exactly the $500 and $1k-$2k build cards. Then sweep the remaining competitor-research gates in `PENDING_MANUAL.md`.
